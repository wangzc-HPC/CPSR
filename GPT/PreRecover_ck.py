...
global_ck_directory = "/lihongliang/wangzc/GPT-2/ck/"
...
def assemble_onefile(cks_directory):
    ...
    assemble_directory = "/lihongliang/wangzc/GPT-2/ck/assemble/"
...
def clean_npy(path):
    ...
    output_file = '/lihongliang/wangzc/GPT-2/ck/module.layer.12.h.mlp.c_fc.weight_norm.npy'
    np.save(output_file, dataset)


def split_temporal():
    path = '/lihongliang/wangzc/GPT-2/ck/1/module.layer.12.h.mlp.c_fc.weight.npy'
    samples = np.load(path)
    split_path = '/lihongliang/wangzc/GPT-2/ck/1/module.layer.12.h.mlp.c_fc.weight_0_60.npy'
...
def recovery(origin_recovery_path):
    ...
    origin_path = '/lihongliang/wangzc/GPT-2/checkpoint/1_0.pth'
...
def integration_loss():
    origin_path = '/lihongliang/wangzc/GPT-2/loss/loss_origin.npy'
    origin_continue_path = '/lihongliang/wangzc/GPT-2/loss/loss_origin_continue.npy'
...
def predict_process():
    assemble("/lihongliang/wangzc/GPT-2/ck/layer.12.h.mlp.c_fc.weight", 2380)  # Takes ~10 minutes
    model_dir = "/lihongliang/wangzc/GPT-2/ck/assemble/layer.12.h.mlp.c_fc.weight"
...
if __name__ == '__main__':
    ...
    npy_path = '/lihongliang/wangzc/GPT-2/ck/1/module.layer.12.h.mlp.c_fc.weight.npy'
